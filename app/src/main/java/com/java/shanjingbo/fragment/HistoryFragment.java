...
public class HistoryFragment extends AbstractListFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (B == null) {
            ...
            setupToolBar();
            onInitialize(B.list, new NewsListAdapter.OnNewsClickListener() {
                @Override
                public void onImageItemClick(NewsBean news) {
                    nav.navigate(HistoryFragmentDirections.actionHistoryFragmentToNewsDetailFragment(news));
                }

                @Override
                public void onVideoItemClick(NewsBean news, int duration) {
                    HistoryFragmentDirections.ActionHistoryFragmentToNewsDetailFragment action =
                            HistoryFragmentDirections.actionHistoryFragmentToNewsDetailFragment(news);
    ...
    protected AbstractPager onCreatePager() {
        return new DBPager(requireContext(), executor, false);
    }
}